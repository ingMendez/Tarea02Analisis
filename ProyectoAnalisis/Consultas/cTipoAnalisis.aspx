<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cTipoAnalisis.aspx.cs" Inherits="ProyectoAnalisis.Consultas.cTipoAnalisis" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card card-register mx-auto mt-5">
        <div class="card-header text-uppercase text-center">Consultar Tipos de Analisis</div>
        <div class="card-body">
            <div class="form-row justify-content-center">
                ...
                <div class="form-group col-md-2">
                    ...
                    <asp:DropDownList ID="FiltroDropDownList" CssClass="form-control" runat="server">
                        ...
                        <asp:ListItem>Id del Tipo</asp:ListItem>
