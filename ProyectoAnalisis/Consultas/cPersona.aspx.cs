...
namespace ProyectoAnalisis.Consultas
{
    public partial class cPersona : System.Web.UI.Page
    {
        ...
        protected void buscarLinkButton_Click(object sender, EventArgs e)
        {
            ...
            ConsultaGridView.DataSource = Utils.FiltrarPersonas(index, CriterioTextBox.Text, desde, hasta);
